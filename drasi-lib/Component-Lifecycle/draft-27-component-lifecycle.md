...
* Draft 27 (owner before cardinality)
...
|---|---|---|---|---|---|---|---|
| Bootstrap provider | `BootstrapProvider` | Host | Source | 0 or 1 | Source bootstrap logic | See 1 | `Added` |
| Identity provider | `IdentityProvider` | Host | DrasiLib | 0 or 1 | Sources and Reactions | Represented | `Added` |
| Index backend | `IndexBackendPlugin` | Host or DrasiLib (default) | DrasiLib | 0 or more; at most 1 default | Queries | Neither | None |
| Query | `Query` | DrasiLib | DrasiLib | 0 or more | Reactions | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Reaction | `Reaction` | Host | DrasiLib | 0 or more | No other component | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Secret store | `SecretStoreProvider` | Host | DrasiLib | 0 or 1 | Configuration loading | Neither | None |
| Source | `Source` | Host | DrasiLib | 0 or more | Queries | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| State store | `StateStoreProvider` | Host or DrasiLib (default) | DrasiLib | 1 | Sources and Reactions | Neither | None |
| WAL provider | `WalProvider` | Host | DrasiLib | 0 or 1 | Sources | Neither | None |

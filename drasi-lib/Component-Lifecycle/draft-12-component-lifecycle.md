...
* Draft 12 (component lifecycle and implementation problems)
* Code: `drasi-core/lib/` (graph under `component_graph/`)

## Components

There are currently nine kinds of Components supported by drasi-lib. The following table describes them:

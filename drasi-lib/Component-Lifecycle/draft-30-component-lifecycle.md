...
* Draft 30 (identity provider ownership note)
...
| Kind | Trait | Creator | Owner | Cardinality | Used By | ComponentGraph | Lifecycle |
|---|---|---|---|---|---|---|---|
| Bootstrap provider | `BootstrapProvider` | Host | Source | 0..1 | Source bootstrap logic | See 1 | `Added` |
| Identity provider | `IdentityProvider` | Host | DrasiLib, Source, or Reaction (See 2) | 0..1 | Sources and Reactions | See 2 | `Added` |
| Index backend | `IndexBackendPlugin` | Host or DrasiLib (default) | DrasiLib | 1.. | Queries | None | None |
| Query | `Query` | DrasiLib | DrasiLib | 0.. | Reactions | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Reaction | `Reaction` | Host | DrasiLib | 0.. | None | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Secret store | `SecretStoreProvider` | Host | DrasiLib | 0..1 | Configuration loading | None | None |
| Source | `Source` | Host | DrasiLib | 0.. | Queries | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| State store | `StateStoreProvider` | Host or DrasiLib (default) | DrasiLib | 1 | Sources and Reactions | None | None |
| WAL provider | `WalProvider` | Host | DrasiLib | 0..1 | Sources | None | None |

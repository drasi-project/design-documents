...
* Draft 33 (creator before creation time)
...
| Kind | Creator | Created At | Owner | Cardinality | Used By | ComponentGraph | Lifecycle |
|---|---|---|---|---|---|---|---|
| Bootstrap provider | Host | With Source | Source | 0..1 | Source bootstrap logic | See 1 | `Added` |
| Identity provider | Host | DrasiLib-owned: build only; Source- or Reaction-owned: build or runtime | DrasiLib, Source, or Reaction (See 2) | 0..1 | Sources and Reactions | See 2 | `Added` |
| Index backend | Host or DrasiLib (default) | Build | DrasiLib | 1.. | Queries | None | None |
| Query | DrasiLib | Build or Runtime | DrasiLib | 0.. | Reactions | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Reaction | Host | Build or Runtime | DrasiLib | 0.. | None | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Secret store | Host | Build | DrasiLib | 0..1 | Configuration loading | None | None |
| Source | Host | Build or Runtime | DrasiLib | 0.. | Queries | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| State store | Host or DrasiLib (default) | Build | DrasiLib | 1 | Sources and Reactions | None | None |
| WAL provider | Host | Build | DrasiLib | 0..1 | Sources | None | None |

...
* Draft 31 (component creation time)
...
| Kind | Trait | Created At | Creator | Owner | Cardinality | Used By | ComponentGraph | Lifecycle |
|---|---|---|---|---|---|---|---|---|
| Bootstrap provider | `BootstrapProvider` | With Source | Host | Source | 0..1 | Source bootstrap logic | See 1 | `Added` |
| Identity provider | `IdentityProvider` | DrasiLib-owned: build only; Source- or Reaction-owned: build or runtime | Host | DrasiLib, Source, or Reaction (See 2) | 0..1 | Sources and Reactions | See 2 | `Added` |
| Index backend | `IndexBackendPlugin` | Build | Host or DrasiLib (default) | DrasiLib | 1.. | Queries | None | None |
| Query | `Query` | Build or Runtime | DrasiLib | DrasiLib | 0.. | Reactions | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Reaction | `Reaction` | Build or Runtime | Host | DrasiLib | 0.. | None | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| Secret store | `SecretStoreProvider` | Build | Host | DrasiLib | 0..1 | Configuration loading | None | None |
| Source | `Source` | Build or Runtime | Host | DrasiLib | 0.. | Queries | Contained | `Added`, `Starting`, `Running`, `Stopping`, `Stopped`, `Reconfiguring`, `Error` |
| State store | `StateStoreProvider` | Build | Host or DrasiLib (default) | DrasiLib | 1 | Sources and Reactions | None | None |
| WAL provider | `WalProvider` | Build | Host | DrasiLib | 0..1 | Sources | None | None |

...
* Draft 22 (ownership and lifecycle states)
...
|---|---|---|---|---|---|
| Bootstrap provider | `BootstrapProvider` | Host | 0 or 1 per Source | Owned by Source | None |
| Identity provider | `IdentityProvider` | Host | 0 or 1 per DrasiLib | Singleton shared by Sources and Reactions | None |
